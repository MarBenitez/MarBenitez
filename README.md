...
Paste any public URL and see exactly what Google, Open Graph and Twitter get back, scored
and audited. Vanilla JS on the front, Node serverless on Vercel for the fetch, because a
browser can't request another site's HTML and something has to do it server-side. One
weekend, no framework: at this size a framework is more setup than tool.

**[marbuilds.dev](https://marbuilds.dev)** · my site: the work, and where to find me

Next.js 16 and React 19, English and Spanish, a generative identity built in three.js.
...
[marbuilds.dev](https://marbuilds.dev) · [LinkedIn](https://www.linkedin.com/in/mar-benitez-506910192) · mar27benitez@gmail.com

*Most of the repos below are from 2024, when I was learning data science in public. The
recent work is private, so the links up there are the receipts.*

*Also: still convinced One Piece is about to get to the point. It has been running since
1997. I apply the same optimism to my backlog.*
